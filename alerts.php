            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h1 class="page-title fw-medium fs-18 mb-2">Alerts</h1>
                            <div class="">
                                <nav>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert svg-secondary alert-secondary alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>
                                        A customized secondary alert with an icon
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert svg-warning alert-warning alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/></svg>
                                        A customized warning alert with an icon
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>
                                    </div>
                                    <div class="alert svg-danger alert-danger alert-dismissible fade show custom-alert-icon shadow-sm" role="alert">
                                    ...
                                    <div class="card border-0">
                                        <div class="alert alert-solid-primary border border-primary mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                <div class="me-2 svg-white">
                                                    <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>
                                                </div>
                                                <div class="text-fixed-white w-100">
                                                    <div class="fw-medium d-flex justify-content-between">Information Alert<button type="button" class="btn-close p-0" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button></div>
                                                    <div class="fs-12 op-8 mb-1">Information alert to show to information</div>
                                                    <div class="fs-12 d-inline-flex">
                                                        <a href="javascript:void(0);" class="text-fixed-white fw-medium me-2 op-7">cancel</a>
                                                        <a href="javascript:void(0);" class="text-fixed-white fw-medium">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card border-0">
                                        <div class="alert alert-solid-secondary border border-secondary mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="text-fixed-white w-100">
                                                    <div class="fw-medium d-flex justify-content-between">Success Alert<button type="button" class="btn-close p-0" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button></div>
                                                    <div class="fs-12 op-8 mb-1">Success alert to show to success message</div>
                                                    <div class="fs-12">
                                                        <a href="javascript:void(0);" class="text-fixed-white fw-medium me-2">close</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card border-0">
                                        <div class="alert alert-solid-warning border border-warning mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="text-fixed-white w-100">
                                                    <div class="fw-medium d-flex justify-content-between">Warning Alert<button type="button" class="btn-close p-0" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button></div>
                                                    <div class="fs-12 op-8 mb-1">Warning alert to show to warning message</div>
                                                    <div class="fs-12 d-inline-flex">
                                                        <a href="javascript:void(0);" class="text-fixed-white fw-medium me-2 op-7">skip</a>
                                                        <a href="javascript:void(0);" class="text-fixed-white fw-medium">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card border-0">
                                        <div class="alert alert-solid-danger border border-danger mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="text-fixed-white w-100">
                                                    <div class="fw-medium d-flex justify-content-between">Danger Alert<button type="button" class="btn-close p-0" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button></div>
                                                    <div class="fs-12 op-8 mb-1">Danger alert to show to danger message</div>
                                                    <div class="fs-12 d-inline-flex">
                                                        <a href="javascript:void(0);" class="text-fixed-white fw-medium me-2 op-7">close</a>
                                                        <a href="javascript:void(0);" class="text-fixed-white fw-medium">continue</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="alert alert-secondary border border-secondary mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="text-secondary w-100">
                                                    ...
                                                    <div class="fs-12 op-8 mb-1">Success alert to show to success message</div>
                                                    <div class="fs-12 d-inline-flex">
                                                        <a href="javascript:void(0);" class="text-danger fw-medium me-2 d-inline-block">cancel</a>
                                                        <a href="javascript:void(0);" class="text-secondary fw-medium">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="alert alert-warning border border-warning mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="text-warning w-100">
                                                    ...
                                                    <div class="fs-12 d-inline-flex">
                                                        <a href="javascript:void(0);" class="text-dark fw-medium me-2 d-inline-block">cancel</a>
                                                        <a href="javascript:void(0);" class="text-warning fw-medium">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="alert alert-danger border border-danger mb-0 p-2">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="text-danger w-100">
                                                    ...
                                                    <div class="fs-12 d-inline-flex">
                                                        <a href="javascript:void(0);" class="text-info fw-medium me-2 d-inline-block">cancel</a>
                                                        <a href="javascript:void(0);" class="text-danger fw-medium">open</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card bg-white border-0">
                                        <div class="alert custom-alert1 alert-primary">
                                            ...
                                            <div class="text-center px-5 pb-0 svg-primary">
                                                <svg class="custom-alert-icon" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>
                                                <h5>Information?</h5>
                                    ...
                                    <div class="card bg-white border-0">
                                        <div class="alert custom-alert1 alert-secondary">
                                            ...
                                            <div class="text-center px-5 pb-0 svg-secondary">
                                                <svg class="custom-alert-icon" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>
                                                <h5>Confirmed</h5>
                                    ...
                                    <div class="card bg-white border-0">
                                        <div class="alert custom-alert1 alert-warning">
                                            ...
                                            <div class="text-center px-5 pb-0 svg-warning">
                                                <svg class="custom-alert-icon" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/></svg>
                                                <h5>Warning</h5>
