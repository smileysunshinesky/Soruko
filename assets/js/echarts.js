...
(function () {
    ...
    option = {
        ...
        color: ["rgb(185, 78, 237)", "rgb(69, 214, 91)", "rgb(243, 156, 18)", "rgb(52, 152, 219)", "rgb(231, 76, 60)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(185, 78, 237)", "rgb(69, 214, 91)", "rgb(243, 156, 18)", "rgb(231, 76, 60)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(185, 78, 237)", "rgb(69, 214, 91)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(185, 78, 237)", "rgb(69, 214, 91)", "rgb(243, 156, 18)", "rgb(231, 76, 60)", "rgb(52, 152, 219)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
