                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <span class="nft-details-auction-time shadow">48hrs : 16mins : 21sec</span>
                                <div class="row gx-5">
                                    <div class="col-xxl-4 col-xl-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-12 col-sm-12 d-md-block d-none">
                                                <p class="fs-15 fw-medium mb-2">Featured NFT's :</p>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fs-14 fw-medium similar-product-name text-truncate">Neo-Nebulae</p>
                                                                                <p class="mb-0">
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fs-14 fw-medium similar-product-name text-truncate">Chromatic Chaos</p>
                                                                                <p class="mb-0">
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-medium similar-product-name text-truncate">Surreal Synthesis</p>
                                                                                <p class="mb-0">
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-medium similar-product-name text-truncate">Virtual Visions</p>
                                                                                <p class="mb-0">
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-medium similar-product-name text-truncate">Pixel Prism</p>
                                                                                <p class="mb-0">
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-medium similar-product-name text-truncate">Electric Euphoria</p>
                                                                                <p class="mb-0">
                                    ...
                                    <div class="col-xxl-8 col-xl-12">
                                        <div class="row gx-5">
                                            <div class="col-xl-12 mt-xxl-0 mt-3">
                                                <div>
                                                    <p class="fs-18 fw-medium mb-0">Digital Dream Space - NFT Digital Art</p>
                                                    <p class="fs-18 mb-4">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                            ...
                                                            <span class="d-block fw-medium">24, Jul 2023 - 12:45PM</span>
                                                        </div>
                                                    </div>
                                                    <div class="mb-4">
