                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div class="btn-list float-end">
                                            ...
                                            <a href="javascript:void(0);" class="avatar avatar-rounded avatar-sm bg-light text-default border" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Add to Wishlist" title="Add to Wishlist"><span><i class="bi bi-heart"></i></span></a>
                                            <a href="javascript:void(0);" class="avatar avatar-rounded avatar-sm bg-light text-default border" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="View Profile" title="View Profile"><span><i class="bi bi-eye"></i></span></a>
                                        </div>
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php"> Charlotte <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php"> Isabella <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                <div class="d-flex gap-2 flex-wrap">
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php"> Abigail <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                <div class="d-flex gap-2 flex-wrap">
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php"> Toni Stark <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                <div class="d-flex gap-2 flex-wrap">
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php"> Christopher <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                <div class="d-flex gap-2 flex-wrap">
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php"> Scarlett <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <a href="javascript:void(0);">Software Developer</a>
                                                    <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Kondapur, Hyderabad</p>
                                                </div> 
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php"> Victoria <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <a href="javascript:void(0);">Web Developer</a>
                                                    <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Gachibowli, Hyderabad</p>
                                                </div> 
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php"> Olivia <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <a href="javascript:void(0);">Python Developer</a>
                                                    <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Gachibowli, Chennai</p>
                                                </div> 
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="job-candidate-details.php">Emily <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <a href="javascript:void(0);">Java Developer</a>
                                                    <p class="mb-0 fs-12 text-muted"><i class="bi bi-geo-alt fs-11"></i> Gachibowli, Banglore</p>
                                                </div> 
