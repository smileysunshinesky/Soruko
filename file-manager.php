                                    ...
                                    <li class="d-flex align-items-center justify-content-center">
                                        <div class="filemanager-upgrade-storage">
                                            ...
                                            <div class="text-default">
                                                <span class="fs-15 fw-medium">Want to <span class="fw-bold text-success"><u>Buy</u></span> Storage?</span>
                                            </div>
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex justify-content-between flex-wrap">
                                                        <div class="file-format-icon svg-warning">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path opacity="0.3" d="m20 9-7-7H7a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3Z"/><path opacity="1" d="M20 9h-5a2 2 0 0 1-2-2V2zm-5 9H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm0-4H9a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2zm-5-4H9a1 1 0 0 1 0-2h1a1 1 0 0 1 0 2z"/></svg>
                                                        </div>
                                                        <div>
                                                            <span class="fw-medium mb-1">
                                                                Docs
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex justify-content-between flex-wrap">
                                                        <div class="file-format-icon svg-purple">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path opacity="0.3" d="M17 21H7a3.003 3.003 0 0 1-3-3V8a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v10a3.003 3.003 0 0 1-3 3Z"/><path opacity="1" d="M19 9H5a3 3 0 0 1 0-6h14a3 3 0 0 1 0 6zm-5 4h-4a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2z"/></svg>
                                                        </div>
                                                        <div>
                                                            <span class="fw-medium mb-1">
                                                                Archives
                                                ...
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex justify-content-between flex-wrap">
                                                        <div class="file-format-icon svg-pink">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect width="9" height="9" x="2" y="2" opacity="1" rx="1"/><rect width="9" height="9" x="2" y="13" opacity="0.3" rx="1"/><rect width="9" height="9" x="13" y="2" opacity="0.3" rx="1"/><rect width="9" height="9" x="13" y="13" opacity="0.3" rx="1"/></svg>
                                                        </div>
                                                        <div>
                                                            <span class="fw-medium mb-1">
                                                                More
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">IMG-09123878-SPK734.jpeg</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Images</td>
                                                    ...
                                                    <tr class="table-active">
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">AMB-2012.zip</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Archives</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">AUD-1002-2012.mp3</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Archives</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                                    data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Document-02.pdf</a>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td>Documents</td>
                            ...
                            <div class="p-3 border-bottom border-block-end-dashed">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <div>
                                            <span class="fw-medium">File Format : </span><span class="fs-12 text-muted">zip</span>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div>
                                            <p class="fw-medium mb-0">File Description : </p>
                                            <span class="fs-12 text-muted">This file contains 3 folder UDON.main & UDON.premium & UDON.featured and 42 images and layout styles are added in this update.</span>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
