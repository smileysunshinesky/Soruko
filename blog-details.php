                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <p class="fs-18 fw-medium mb-1">Touring excites in winter when we travel with friends !</p>
                                        <div class="d-sm-flex align-items-cneter">
                                            <div class="d-flex align-items-center flex-fill">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-medium">Toni Stark - <span class="fs-11 text-muted fw-normal">Tue,25 Dec 2023 - 11:45</span></p>
                                        ...
                                        <div class="card custom-card bg-light mb-5 shadow-none">
                                            ...
                                            <div class="card-body">
                                              <blockquote class="blockquote mb-0 text-center">
                                                <p class="fs-16 fw-medium mb-2 text-dark">In nature, nothing is perfect and everything is perfect. Trees can be contorted, bent in weird ways, and they're still beautiful..</p>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <p class="mb-1 fs-15 fw-medium text-dark lh-1">Emiley Jackson</p>
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                <div class="d-flex gap-3 flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Animals</a>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex gap-3 flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Travel</a>
                                                        <p class="mb-1 popular-blog-content text-truncate">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex gap-3 flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Interior</a>
                                                        <p class="mb-1 popular-blog-content text-truncate">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex gap-3 flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Nature</a>
                                                        <p class="mb-1 popular-blog-content text-truncate">
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            <h6 class="fw-medium mb-3"><span class="text-primary fs-18">1658</span> Subscribers</h6>
