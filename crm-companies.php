            ...
            <div class="container-fluid">
                                            ...
                                            <tr class="crm-contact">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <span class="d-block fw-medium">Toni Stark</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                ...
                aria-labelledby="offcanvasExample">
                    <div class="offcanvas-body p-0">
                        <div class="d-sm-flex align-items-top p-4 border-bottom border-block-end-dashed main-profile-cover bg-primary">
                            <div>
                            ...
                            <div class="flex-fill main-profile-info">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h6 class="fw-medium mb-1 text-fixed-white">Spruko Technologies</h6>
                                ...
                                <div class="d-flex mb-0">
                                    <div class="me-4">
                                        <p class="fw-medium fs-20 text-fixed-white text-shadow mb-0">113</p>
                                        <p class="mb-0 fs-11 op-5 text-fixed-white">Deals</p>
                                    </div>
                                    <div class="me-4">
                                        <p class="fw-medium fs-20 text-fixed-white text-shadow mb-0">$12.2k</p>
                                        <p class="mb-0 fs-11 op-5 text-fixed-white">Contributions</p>
                                    </div>
                                    <div class="me-4">
                                        <p class="fw-medium fs-20 text-fixed-white text-shadow mb-0">$10.67k</p>
