            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xxl-9">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card custom-card overlay-card overflow-visible nft-banner">
                                    <img src="assets/images/nft-images/23.png" class="card-img rounded" alt="...">
                                    <div class="card-img-overlay d-flex flex-column p-0">
                                        <div
                                            class="card-body nft-main d-flex align-items-center justify-content-between">
                                            <div>
                                                <h1 class="nft-title text-fixed-white mb-4">Discover, Sell, Collect and
                                                    create your own NFT'S</h1>
                                                <div class="btn-list">
                                                    <button class="btn btn-light rounded-pill btn-w-md">Discover
                                                        Now</button>
                                                    <button
                                                        class="btn btn-white-transparent rounded-pill btn-w-md">Create</button>
                                                </div>
                                            </div>
                                            <div>
                                                <img src="assets/images/nft-images/24.png" alt=""
                                                    class="nft-main-image img-fluid d-xxl-block d-none">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="card custom-card overflow-hidden">
                                            <img src="assets/images/nft-images/2.png" class="card-img-top nft-image"
                                                alt="...">
                                            <div
                                                class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                <div class="flex-fill">
                                                    <button
                                                        class="btn btn-sm btn-icon btn-success rounded-pill btn-wave">
                                                        <i class="ri-heart-fill"></i>
                                                    </button>
                                                </div>
                                                <div>
                                                    <span class="badge nft-like-badge text-fixed-white"><i
                                                            class="ri-heart-fill me-1 text-danger align-middle d-inline-block"></i>1.32k</span>
                                                </div>
                                            </div>
                                            <div class="card-body nft-body">
                                                <div
                                                    class="d-flex align-items-center mb-3 text-fixed-white flex-wrap gap-2">
                                                    <div class="lh-1">
                                                    ...
                                                    <div class="flex-fill">
                                                        <p class="mb-0">Bloom NFT</p>
                                                        <p class="fs-12 op-8 mb-0">@bloom116</p>
                                                    </div>
                                                    <div class="mb-0 text-fixed-white nft-auction-time">
                                                        04hrs : 24m : 38s
                                                    </div>
                                                </div>
                                                <p class="fs-15 mb-2 text-fixed-white">Color Abstract - NFT</p>
                                                <div
                                                    class="d-flex flex-wrap text-fixed-white align-items-center justify-content-between">
                                                    <div>
                                                        Highest Bid -
                                                    </div>
                                        ...
                                        <div class="d-grid">
                                            <button class="btn btn-primary btn-wave mb-md-0 mb-4">Place Bid</button>
                                        </div>
                                    </div>
                                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="card custom-card overflow-hidden">
                                            <img src="assets/images/nft-images/3.png" class="card-img-top nft-image"
                                                alt="...">
                                            <div
                                                class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                <div class="flex-fill">
                                                ...
                                                <div>
                                                    <span class="badge nft-like-badge text-fixed-white"><i
                                                            class="ri-heart-fill me-1 text-danger align-middle d-inline-block"></i>1.26k</span>
                                                </div>
                                            </div>
                                            <div class="card-body nft-body">
                                                <div
                                                    ...
                                                    <div class="flex-fill">
                                                        <p class="mb-0">Ergos NFT</p>
                                                        <p class="fs-12 op-8 mb-0">@ergos900</p>
                                                    </div>
                                                    <div class="mb-0 text-fixed-white nft-auction-time">
                                                        04hrs : 24m : 38s
                                                    </div>
                                                ...
                                                <p class="fs-15 mb-2 text-fixed-white">Fluid Abstract - NFT</p>
                                                <div
                                                    class="d-flex flex-wrap text-fixed-white align-items-center justify-content-between">
                                                    <div>
                                                        Highest Bid -
                                    ...
                                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="card custom-card overflow-hidden">
                                            <img src="assets/images/nft-images/5.png" class="card-img-top nft-image"
                                                alt="...">
                                            <div
                                                class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                                <div class="flex-fill">
                                                ...
                                                <div>
                                                    <span class="badge nft-like-badge text-fixed-white"><i
                                                            class="ri-heart-fill me-1 text-danger align-middle d-inline-block"></i>2.45k</span>
                                                </div>
                                            </div>
                                            <div class="card-body nft-body">
                                                <div
                                                    ...
                                                    <div class="flex-fill">
                                                        <p class="mb-0">Caros NFT</p>
                                                        <p class="fs-12 op-8 mb-0">@caros002</p>
                                                    </div>
                                                    <div class="mb-0 text-fixed-white nft-auction-time">
                                                        04hrs : 24m : 38s
                                                    </div>
                                                </div>
                                                <p class="fs-15 mb-2 text-fixed-white">Space Fluid - NFT</p>
                                                <div
                                                    class="d-flex flex-wrap text-fixed-white align-items-center justify-content-between">
                                                    <div>
                                                        Highest Bid -
                                ...
                                <div class="card custom-card">
                                    <div class="card-header justify-content-between flex-wrap">
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <button type="button"
                                                class="btn btn-primary-light btn-sm btn-wave">1W</button>
                                            <button type="button"
                                                class="btn btn-primary-light btn-sm btn-wave">1M</button>
                                            <button type="button"
                                                class="btn btn-primary-light btn-sm btn-wave">3M</button>
                                            <button type="button"
                                                class="btn btn-primary-light btn-sm btn-wave">6M</button>
                                            <button type="button"
                                                class="btn btn-primary-light btn-sm btn-wave">1Y</button>
                                        </div>
                                    </div>
                                    <div class="card-body p-0">
                                        <div
                                            class="d-flex flex-wrap p-3 border-bottom border-block-end-dashed flex-wrap gap-3">
                                            <div class="me-3">
                                            ...
                                            <div
                                                class="d-flex flex-wrap justify-content-evenly flex-fill flex-wrap gap-3">
                                                ...
                                                <div class="m-sm-0 m-2">
                                                    <span>Price (USD)</span>
                                                    <p class="text-success mb-0">$1,212.67</p>
                                                </div>
                                                <div class="m-sm-0 m-2">
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-5 col-md-12 col-sm-12">
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <button
                                            class="btn btn-sm btn-primary-light btn-wave waves-effect waves-light">View
                                            All</button>
                                    </div>
                                </div>
                                                ...
                                                <div class="card-header">
                                                    <div
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                                <span
                                                                    class="avatar avatar-rounded bg-light p-1 avatar-xs">
                                                                    <img src="assets/images/crypto-currencies/regular/Ethereum.svg"
                                                                        alt="">
                                                                </span>
                                                            </div>
                                                                ...
                                                                <span class="avatar avatar-md avatar-rounded">
                                                                    ...
                                                                    <a href="javascript:void(0);"
                                                                        class="badge rounded-pill bg-primary avatar-badge"><i
                                                                            class="ri-check-line align-mmiddle"></i></a>
                                                                </span>
                                                            </div>
                                                            <div>
                                                                <p class="mb-0"><a href="javascript:void(0);">Simon
                                                                        Cowell</a></p>
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <div class="text-muted fs-12 d-flex align-items-center">
                                                                Collection Rank :
                                                                <span
                                                                    class="fw-medium text-success fs-15 mb-0 ms-1">#2</span>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <div class="text-muted fs-12 d-flex align-items-center">
                                                                Collection Rank :
                                                                <span
                                                                    class="fw-medium text-success fs-15 mb-0 ms-1">#3</span>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2 lh-1">
                                                ...
                                                <div class="card-header">
                                                    <div class="d-flex align-items-center flex-fill">
                                                        <div class="d-flex align-items-center flex-fill">
                                                            ...
                                                            <div>
                                                                <p class="mb-0 fw-medium"><a
                                                                        href="javascript:void(0);">Json Talor</a></p>
                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-xl-6">
                                <div class="card custom-card overflow-hidden">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled nft-trending-collectors">
                                            <li>
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="align-items-center">
                                                            <p class="mb-0">Amanda Nanes<i
                                                                    class="bi bi-check-circle-fill align-middle text-green ms-2"></i>
                                                            </p>
                                                    ...
                                                    <div>
                                                        <button
                                                            class="btn btn-sm btn-secondary btn-wave rounded-pill">Following</button>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="align-items-center">
                                                            <p class="mb-0">Charles Achilles<i
                                                                    class="bi bi-check-circle-fill align-middle text-green ms-2"></i>
                                                            </p>
                                                    ...
                                                    <div>
                                                        <button
                                                            class="btn btn-sm btn-outline-secondary btn-wave rounded-pill">Follow</button>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="align-items-center">
                                                            <p class="mb-0">Sean Abott<i
                                                                    class="bi bi-check-circle-fill align-middle text-green ms-2"></i>
                                                            </p>
                                                            <span class="fs-12 text-muted">@seanabott</span>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <button
                            ...
                            <div class="col-xxl-12 col-xl-6">
                                <div class="card custom-card overflow-hidden">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled top-drops-list">
                                            <li>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <span class="d-block">Pixel Pioneers</span>
                                                        <span class="fs-12 text-muted">Sold at 1.25 BTC</span>
                                                    </div>
                                                    <div class="text-muted">4 hrs ago</div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <span class="d-block">Nifty Notions</span>
                                                        <span class="fs-12 text-muted">Sold at 0.64 BTC</span>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <span class="d-block">NFT Nexus</span>
                                                        <span class="fs-12 text-muted">Sold at 0.51 BTC</span>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <span class="d-block">BlockBeauty</span>
                                                        <span class="fs-12 text-muted">Sold at 0.80 BTC</span>
                                                    </div>
                                                    <div class="text-muted">1 hr ago</div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <span class="d-block">Adobeanachy</span>
                                                        <span class="fs-12 text-muted">Sold at 1.27 BTC</span>
                                                    </div>
                                                    <div class="text-muted">24 mins ago</div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="me-2">
                                                                    <span
                                                                        class="avatar avatar-md p-2 avatar-rounded bg-light">
                                                                        <img src="assets/images/faces/5.jpg" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="fw-medium">Alicia Smith</div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div id="trending-creator1"></div>
                                                        </td>
                                                        <td class="text-end">
                                                            <p class="mb-0">$9,223.46</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="fw-medium">Alex Carey</div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div id="trending-creator2"></div>
                                                        </td>
                                                        <td class="text-end">
                                                            <p class="mb-0">$17,239.09</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="fw-medium">Emiley Jack</div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div id="trending-creator3"></div>
                                                        </td>
                                                        <td class="text-end">
                                                            <p class="mb-0">$5,902.83</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div id="trending-creator4"></div>
                                                        </td>
                                                        <td class="text-end">
                                                            <p class="mb-0">$3,993.09</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="fw-medium">Toni Stark</div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div id="trending-creator5"></div>
                                                        </td>
                                                        <td class="text-end">
                                                            <p class="mb-0">$12,124.34</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border-bottom-0">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="fw-medium">Kiara May</div>
                                                            </div>
                                                        </td>
                                                        <td class="border-bottom-0">
                                                            <div id="trending-creator6"></div>
                                                        </td>
                                                        <td class="border-bottom-0 text-end">
                                                            <p class="mb-0">$2,534.56</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="dropdown">
                                        <a href="javascript:void(0);"
                                            ...
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            Sort By<i
                                                class="ri-arrow-down-s-line align-middle ms-1 d-inline-block d-inline-block"></i>
                                        </a>
                                        <ul class="dropdown-menu" role="menu">
                                        ...
                                        <tbody>
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="mb-0"><a href="javascript:void(0);"
                                                                    title="nft_name">Starter Sense NFT</a></p>
                                                            <a href="javascript:void(0);"
                                                                class="fs-12 text-muted fw-normal"
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="mb-0"><a href="javascript:void(0);"
                                                                    title="nft_name">2.56ETH</a></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="text-success"><i
                                                            class="ti ti-trending-up me-1 align-middle d-inline-block"></i>15.2%</span>
                                                </td>
                                                <td><span class="text-success"><i
                                                            class="ti ti-trending-up me-1 align-middle d-inline-block"></i>3.1%</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 lh-1">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="mb-0"><a href="javascript:void(0);"
                                                                    title="nft_name">Lorem Kekkei</a></p>
                                                            <a href="javascript:void(0);"
                                                                class="fs-12 text-muted fw-normal"
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="mb-0"><a href="javascript:void(0);"
                                                                    title="nft_name">1.25ETH</a></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="text-success"><i
                                                            class="ti ti-trending-up me-1 align-middle d-inline-block"></i>3.7%</span>
                                                </td>
                                                <td><span class="text-danger"><i
                                                            class="ti ti-trending-down me-1 align-middle d-inline-block"></i>0.5%</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 lh-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="mb-0"><a href="javascript:void(0);"
                                                                    title="nft_name">2,092ETH</a></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-danger"><i
                                                            class="ti ti-trending-down me-1 align-middle d-inline-block"></i>23.1%</span>
                                                </td>
                                                <td>
                                                    <span class="text-success"><i
                                                            class="ti ti-trending-up me-1 align-middle d-inline-block"></i>9.12%</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 lh-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <p class="mb-0"><a href="javascript:void(0);"
                                                                    title="nft_name"> 36.25ETH</a></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><span class="text-danger"><i
                                                            class="ti ti-trending-down me-1 align-middle d-inline-block"></i>5.2%</span>
                                                </td>
                                                <td>
                                                    <span class="text-danger"><i
                                                            class="ti ti-trending-down me-1 align-middle d-inline-block"></i>4.1%</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 lh-1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-bottom-0"><span
                                                        class="fw-medium text-primary">#5</span></td>
                                                <td class="border-bottom-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 lh-1">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                        ...
                                                        <div>
                                                            <p class="mb-0"><a href="javascript:void(0);"
                                                                    title="nft_name">12.52ETH</a></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="border-bottom-0"><span class="text-success"><i
                                                            class="ti ti-trending-up me-1 align-middle d-inline-block"></i>7.0%</span>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <span class="text-success"><i
                                                            class="ti ti-trending-up me-1 align-middle d-inline-block"></i>12.5%</span>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2 lh-1">
                                                        ...
                                                        <div>
                                                            <p class="mb-0"><a href="javascript:void(0);"
                                                                    title="nft_name">12.50ETH</a></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="border-bottom-0">121.5K</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
