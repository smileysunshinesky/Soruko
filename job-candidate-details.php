                ...
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center flex-wrap justify-content-between gap-2">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="fw-medium mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Charlotte <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h4>
                                            <a href="javascript:void(0);" class="fw-medium"><i class="bi bi-briefcase me-1"></i> Software Developer</a>
                                            ...
                                            <div class="d-flex fs-14 mt-3">
                                                ...
                                                <div class="ms-4">
                                                    <p class="mb-1"><i class="bi bi-coin me-2"></i>Package (Yearly) : <span class="fw-medium" data-bs-toggle="tooltip" title="Current Salary">$10,000</span> - <span class="fw-medium" data-bs-toggle="tooltip" title="Expected Salary">$20,000</span></p>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body p-0 candidate-edu-timeline">
                                <div class="p-4 border-bottom">
                                    <h5 class="fw-medium fs-17 d-flex align-items-center gap-2"><span class="avatar avatar-rounded bg-primary avatar-sm"><i class="bi bi-briefcase fs-13"></i></span> Career Objective :</h5>
                                    <div class="ms-4 ps-3">
                                ...
                                <div class="p-4 border-bottom">
                                    <h5 class="fw-medium fs-17 d-flex align-items-center gap-2"><span class="avatar avatar-rounded bg-primary avatar-sm"><i class="bi bi-mortarboard fs-13"></i></span> Education :</h5>
                                    <div class="ms-4 ps-3">
                                        ...
                                        <p class="mb-4"> (2019 Mar - 2023 Apr)</p>
                                ...
                                <div class="p-4 border-bottom">
                                    <h5 class="fw-medium fs-17 d-flex align-items-center gap-2"><span class="avatar avatar-rounded bg-primary avatar-sm"><i class="bi bi-award fs-13"></i></span> Certifications :</h5>
                                    <div class="ms-4 ps-3">
                                ...
                                <div class="p-4 border-bottom">
                                    <h5 class="fw-medium fs-17 d-flex align-items-center gap-2"><span class="avatar avatar-rounded bg-primary avatar-sm"><i class="bi bi-journal-medical fs-13"></i></span> Publications :</h5>
                                    <div class="ms-3">
                                ...
                                <div class="p-4 border-bottom">
                                    <h5 class="fw-medium fs-17 d-flex align-items-center gap-2"><span class="avatar avatar-rounded bg-primary avatar-sm"><i class="bi bi-activity fs-13"></i></span> Activities and Interests :</h5>
                                    <div class="ms-3">
                                        <ol class="list-group border-0 list-bullets">
                                ...
                                <div class="p-4 border-bottom">
                                    <h5 class="fw-medium fs-17 d-flex align-items-center gap-2"><span class="avatar avatar-rounded bg-primary avatar-sm"><i class="bi bi-link-45deg fs-13"></i></span> References :</h5>
                                    <div class="ms-4 ps-3">
                                        <p><span class="fw-medium">Name : </span> Nicole Chiu</p>
                                        <p><span class="fw-medium">Designation : </span> Software Developer</p>
                                        <p><span class="fw-medium">Company Name : </span> Spotech Technical Solutions</p>
                        ...
                        <div class="card custom-card">
                            <div class="card-header">
                                <div class="card-title">
                                    <h5 class="mb-0 fw-medium">Experience Overview</h5>                                        
                                </div>
                            </div>
                            <div class="card-body p-0 candidate-edu-timeline">
                                <div class="p-4 border-bottom">
                                    <h5 class="fw-medium fs-17 d-flex align-items-center gap-2"><span class="avatar avatar-rounded bg-primary avatar-sm"><i class="bi bi-briefcase fs-13"></i></span> Experience :</h5>
                                    <div class="ms-4 ps-3">
                                        <p class="fw-medium fs-14 mb-0">Full Stack Developer (2019 Mar - 2023 Apr)</p>
                                        <div class="d-flex gap-2">
                                ...
                                <div class="p-4 border-bottom">
                                    <h5 class="fw-medium fs-17 d-flex align-items-center gap-2"><span class="avatar avatar-rounded bg-primary avatar-sm"><i class="bi bi-people fs-13"></i></span> Volunteer Experience :</h5>
                                    <div class="ms-4 ps-3">
                        ...
                        <div class="card custom-card border bg-primary-transparent shadow-none">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <h5 class="fw-medium mb-0">&#128400; Was this profile fit for someone?</h5>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <p><span class="fw-medium">English : </span>Fluent</p>
                                <p><span class="fw-medium">Hindi : </span>Intermediate</p>
                                <p class="mb-0"><span class="fw-medium">Telugu : </span>Expert</p>
                            </div>
                        </div>
                        <div class="card custom-card overflow-hidden">
                            <div class="card-header">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="">
                                    <h5 class="fw-medium mb-3">Get Latest Alerts</h5>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Brenda Simpson <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                        <div class="d-flex gap-2">
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Dwayne Stort <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                        <div class="d-flex gap-2">
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                                    ...
                                                    <div class="flex-fill">
                                                        <h5 class="fw-medium mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Jasmine Kova <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                                        <div class="d-flex gap-2">
