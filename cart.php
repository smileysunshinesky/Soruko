                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xxl-9">
                                        <div class="card custom-card overflow-hidden shadow-none border mb-0" id="cart-container-delete">
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <div class="d-flex align-items-start">
                                                                        ...
                                                                        <div>
                                                                            <div class="mb-1 fs-14 fw-medium">
                                                                                <a href="javascript:void(0);">Narichavo Branded Headphones</a>
                                                                            </div>
                                                                            <div class="mb-1">
                                                                                <span class="me-1">Size:</span><span class="fw-normal text-muted">Free</span>
                                                                            </div>
                                                                            <div class="mb-2">
                                                                                <span class="me-1">Color:</span><span class="fw-normal text-muted">Black<span class="badge bg-success-transparent ms-3">In Stock</span></span>
                                                                            </div>
                                                                            <div class="hstack gap-3">
                                                                               <a href="javascript:void(0)" class="fs-12 link-primary fw-normal">Save for later</a>
                                                                               <div class="vr"></div>
                                                                               <a href="javascript:void(0)" class="link-primary fw-normal">Share</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="product-quantity-container">
                                                                    <div class="input-group rounded flex-nowrap">
                                                                        <button class="btn btn-icon btn-outline-light bg-transparent border input-group-text flex-fill product-quantity-minus border-end-0" ><i class="ri-subtract-line"></i></button>
                                                                        <input type="text" class="form-control form-control-sm text-center w-100" aria-label="quantity" id="product-quantity" value="2">
                                                                        <button class="btn btn-icon btn-outline-light bg-transparent border input-group-text flex-fill product-quantity-plus border-start-0" ><i class="ri-add-line"></i></button>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <a href="wishlist.php" class="btn btn-icon btn-success-ghost me-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Wishlist"><i class="ri-heart-line"></i></a>
                                                                    <button class="btn btn-icon btn-danger-ghost btn-delete" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Remove From cart">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-start">
                                                                        ...
                                                                        <div>
                                                                            <div class="mb-1 fs-14 fw-medium">
                                                                                <a href="javascript:void(0);">Jam & Honey Teddy Bear, Cute, Soft Toy (33 Cm, brown, Cream)</a>
                                                                            </div>
                                                                            <div class="mb-1">
                                                                                <span class="me-1">Size:</span><span class="fw-normal text-muted">33 Cm</span>
                                                                            </div>
                                                                            <div class="mb-2">
                                                                                <span class="me-1">Color:</span><span class="fw-normal text-muted">Brown<span class="badge bg-secondary ms-3">25% off</span><span class="badge bg-light text-default ms-3 border">Out Off Stock</span></span>
                                                                            </div>
                                                                            <div class="hstack gap-3">
                                                                               <a href="javascript:void(0)" class="fs-12 link-primary fw-normal">Save for later</a>
                                                                               <div class="vr"></div>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-start">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div class="mb-1">
                                                                                <span class="me-1">Size:</span><span class="fw-normal text-muted">9</span>
                                                                            </div>
                                                                            <div class="mb-2">
                                                                                <span class="me-1">Color:</span><span class="fw-normal text-muted">Light Gray<span class="badge bg-success-transparent ms-3">In Stock</span></span>
                                                                            </div>
                                                                            <div class="hstack gap-3">
                                                                               <a href="javascript:void(0)" class="fs-12 link-primary fw-normal">Save for later</a>
                                                                               <div class="vr"></div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-start">
                                                                        <div class="me-3">
                                                                            <span class="avatar avatar-xxl bg-light">
                                                                                <img src="assets/images/ecommerce/jpg/10.jpg" alt="">
                                                                            </span>
                                                                        </div>
                                                                        <div>
                                                                            <div class="mb-1 fs-14 fw-medium">
                                                                                <a href="javascript:void(0);">Men's Cotton Blend Hooded Cardigan</a>
                                                                            </div>
                                                                            <div class="mb-1">
                                                                                <span class="me-1">Size:</span><span class="fw-normal text-muted">Medium</span>
                                                                            </div>
                                                                            <div class="mb-2">
                                                                                <span class="me-1">Color:</span><span class="fw-normal text-muted">Light Blue<span class="badge bg-success-transparent ms-3">In Stock</span></span>
                                                                            </div>
                                                                            <div class="hstack gap-3">
                                                                               <a href="javascript:void(0)" class="fs-12 link-primary fw-normal">Save for later</a>
                                                                               <div class="vr"></div>
                                                            ...
                                                            <tr>
                                                                <td class="border-bottom-0">
                                                                    <div class="d-flex align-items-start">
                                                                        ...
                                                                        <div>
                                                                            <div class="mb-1 fs-14 fw-medium">
                                                                                <a href="javascript:void(0);">SPK Step Out 12 L Mini Backpack (Small Size, Yellow, Water Repellant)</a>
                                                                            </div>
                                                                            <div class="mb-1">
                                                                                <span class="me-1">Size:</span><span class="fw-normal text-muted">Small</span>
                                                                            </div>
                                                                            <div class="mb-2">
                                                                                <span class="me-1">Color:</span><span class="fw-normal text-muted">Yellow</span>
                                                                            </div>
                                                                            <div class="hstack gap-3">
                                                                               <a href="javascript:void(0)" class="fs-12 link-primary fw-normal">Save for later</a>
                                                                               <div class="vr"></div>
                                                                ...
                                                                <td class="border-bottom-0 product-quantity-container">
                                                                    <div class="input-group rounded flex-nowrap">
                                                                        <button class="btn btn-icon btn-outline-light bg-transparent border input-group-text flex-fill product-quantity-minus border-end-0"><i class="ri-subtract-line"></i></button>
                                        ...
                                        <div class="card custom-card shadow-none border mb-0">
                                            <div class="p-3 border-bottom d-block">
                                                <div class="alert alert-success text-center" role="alert">
                                                    <span class="text-default">Sale Ends in</span> <span class="fw-medium fs-14 text-success ms-1">18 Hours : 32 Minutes</span>
                                                </div>
                                            </div>
                                            <div class="card-body p-0">
                                                <div class="p-3 border-bottom border-block-end-dashed">
                                                    <p class="mb-2 fw-medium">Delivery:</p>
                                                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                        <input type="radio" class="btn-check" name="btnradio" id="btnradio1">
                                                        <label class="btn btn-outline-primary text-default" for="btnradio1">Free Delivery</label>
                                                        <input type="radio" class="btn-check" name="btnradio" id="btnradio2" checked="">
                                                        <label class="btn btn-outline-primary text-default" for="btnradio2">Express Delivery</label>
                                                    </div>
                                                    <p class="mb-0 mt-2 fs-12 text-muted">Delivered by 24,Nov 2023</p>
                                                </div>
                                                <div class="p-3 border-bottom border-block-end-dashed">
                                                ...
                                                <div class="p-3 border-bottom border-block-end-dashed">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <div class="fw-medium fs-14">$1,299</div>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <div class="text-muted op-7">Discount</div>
                                                        <div class="fw-medium fs-14 text-success">10% - $129</div>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <div class="text-muted op-7">Delivery Charges</div>
                                                        <div class="fw-medium fs-14 text-danger">- $49</div>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <div class="text-muted op-7">Service Tax (18%)</div>
                                                        <div class="fw-medium fs-14">- $169</div>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="text-muted op-7">Total :</div>
                                                        <div class="fw-medium fs-14 text-primary"> $1,387</div>
                                                    </div>
                                                </div>
                                                <div class="p-3 d-grid">
                                                    <a href="checkout.php" class="btn btn-primary btn-wave mb-2">Proceed To Checkout</a>
                                                    <a href="products.php" class="btn btn-secondary btn-wave">Countinue Shopping</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
