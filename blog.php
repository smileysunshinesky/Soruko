                 ...
                 <div class="row">
                    <div class="col-xl-12">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0 fw-medium">Trending Topics</h5>
                                    ...
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                                                <h6 class="fw-medium mb-0 text-fixed-white">Nature</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                                                <h6 class="fw-medium mb-0 text-fixed-white">Sports</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                                                <h6 class="fw-medium mb-0 text-fixed-white">Food</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                                                <h6 class="fw-medium mb-0 text-fixed-white">Travel</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                                                <h6 class="fw-medium mb-0 text-fixed-white">Fashion</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                                                <h6 class="fw-medium mb-0 text-fixed-white">Animals</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                        ...
                                        <div class="carousel-item active" data-bs-interval="2000">
                                            <a href="javascript:void(0);">
                                                ...
                                                <div class="carousel-caption blog-caption text-start">
                                                    ...
                                                    <h6 class="fw-medium mb-2 text-fixed-white">N.A.S.A</h6>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm avatar-rounded me-2">
                                                            <img src="assets/images/faces/15.jpg" alt="">
                                                        </span>
                                                        <div class="fw-medium">Toni Stark - <span class="fs-11 op-7 fw-normal">12,Dec 2023 - 04:34PM</span></div>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <a href="javascript:void(0);">
                                                ...
                                                <div class="carousel-caption blog-caption text-start">
                                                    ...
                                                    <h6 class="fw-medium mb-2 text-fixed-white">NASA Businesses</h6>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm avatar-rounded me-2">
                                                            <img src="assets/images/faces/15.jpg" alt="">
                                                        </span>
                                                        <div class="fw-medium">Elisha Keens - <span class="fs-11 op-7 fw-normal">23,Dec 2023 - 11:27AM</span></div>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <a href="javascript:void(0);">
                                                ...
                                                <div class="carousel-caption blog-caption text-start">
                                                    ...
                                                    <h6 class="fw-medium mb-2 text-fixed-white">NASA Leadership</h6>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm avatar-rounded me-2">
                                                            <img src="assets/images/faces/4.jpg" alt="">
                                                        </span>
                                                        <div class="fw-medium">Melissa Blue - <span class="fs-11 op-7 fw-normal">16,Dec 2023 - 9:45AM</span></div>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <a href="blog-details.php" class="fw-medium fs-14 text-dark mb-1">Touring excites in winter !</a>
                                        <p class="card-text text-muted mb-4">The holographic principle, theorized to be a property of quantum gravity, postulates that the descriptionThe holographic principle, theorized to be a property of quantum gravity, postulates that the descriptionThe holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-muted fs-11 mb-0">20,Dec 2023 - 16:32</p>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <a href="blog-details.php" class="fw-medium fs-14 text-dark mb-1"> Boat manufacutrers are in debt !</a>
                                        <p class="card-text text-muted mb-4">when an unknown printer took a galley of type and scrambled it to make a type specimen book,The holographic principle, theorized to be a property of quantum gravity, postulates that the descriptionThe holographic principle, theorized to be a property of quantum gravity, postulates that.</p>
                                        <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                    </div>
                                    <div class="card-footer">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-muted fs-11 mb-0">25,Dec 2023 - 12:45</p>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm"><i class="ri-thumb-up-line"></i></button>
                                ...
                                <div class="row">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        <div class="card custom-card">
                                            ...
                                            <div class="card-body">
                                                <a href="blog-details.php" class="fw-medium fs-14 text-dark mb-1">Features of new car !</a>
                                                ...
                                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-muted fs-11 mb-0">18,Dec 2023 - 12:25</p>
                                                        </div>
                                                    </div>
                                                    <div class="btn-list">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        <div class="card custom-card">
                                            ...
                                            <div class="card-body">
                                                <a href="blog-details.php" class="fw-medium fs-14 text-dark mb-1">Beautiful beach on a sunny day !</a>
                                                <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                            </div>
                                            <div class="card-footer">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-muted fs-11 mb-0">25,Dec 2023 - 04:25</p>
                                                        </div>
                                                    </div>
                                                    <div class="btn-list">
                                                        <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm m-1"><i class="ri-thumb-up-line"></i></button>
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Samantha Jack</a>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Kirsten Sam</a>
                                                        <p class="mb-1 popular-blog-content text-truncate">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Jessica Karon</a>
                                                        <p class="mb-1 popular-blog-content text-truncate">
                                                            Ipsum omnis non fugit ad voluptate consequuntur, sed veritatis nesciunt, asperiores, provident temporibus!
                                                        </p>
                                                        <span class="text-muted fs-11">28,Sep 2023 - 08:32</span>
                                                    </div>
                                                    <div>
                                                        <button class="btn btn-icon btn-light btn-sm rtl-rotate"><i class="ri-arrow-right-s-line"></i></button>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center">
                                                    <span class="avatar avatar-xl me-3">
                                                        <img src="assets/images/media/media-25.jpg" class="img-fluid" alt="...">
                                                    </span>
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Melissa Jackson</a>
                                                        <p class="mb-1 popular-blog-content text-truncate">
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Broad Stuart</a>
                                                        <p class="mb-1 popular-blog-content text-truncate">
                        ...
                        <div class="row">
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <a href="blog-details.php" class="fw-medium fs-14 text-dark mb-1">Strawberry juice recipe.</a>
                                        <p class="card-text text-muted mb-3">Want to have something different but healthy to drink? Then look no further!! Strawberry Juice is rich.</p>
                                        <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                    </div>
                                    <div class="card-footer">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-medium">Maria Bose</p>
                                                    <p class="text-muted fs-11 mb-0">17,Dec 2023 - 12:32</p>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm"><i class="ri-thumb-up-line"></i></button>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <a href="blog-details.php" class="fw-medium fs-14 text-dark mb-1">Night Sky is pleasent to watch.</a>
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-medium">Helsenky</p>
                                                    <p class="text-muted fs-11 mb-0">24,Dec 2023 - 14:21</p>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm"><i class="ri-thumb-up-line"></i></button>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <a href="blog-details.php" class="fw-medium fs-14 text-dark mb-1">Is fashion industry growing ?</a>
                                        <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity.</p>
                                        <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                    </div>
                                    <div class="card-footer">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-medium">Jason Mama</p>
                                                    <p class="text-muted fs-11 mb-0">19,Dec 2023 - 15:48</p>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm"><i class="ri-thumb-up-line"></i></button>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body">
                                        <a href="blog-details.php" class="fw-medium fs-14 text-dark mb-1">Raising sun is a blessing to watch ..</a>
                                        <p class="card-text text-muted mb-3">Rising Sun is a 1993 American buddy cop crime thriller film directed by Philip Kaufman buddy cop crime thriller film.</p>
                                        <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                    </div>
                                    <div class="card-footer">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-medium">Stuart Hall</p>
                                                    <p class="text-muted fs-11 mb-0">13,Dec 2023 - 19:08</p>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm"><i class="ri-thumb-up-line"></i></button>
