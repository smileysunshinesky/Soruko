                    ...
                    <div class="col-xl-9">
                        <div class="card custom-card">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 ms-auto mt-sm-0 mt-3">
                                                ...
                                                <div class="row gy-2">
                                                    <div class="col-xl-12">
                                                        <input type="text" class="form-control form-control-light" id="customer-Name" placeholder="Customer Name" value="Toni Stark">
                                                    </div>
                                                    <div class="col-xl-12">
                            ...
                            <div class="card-footer text-end">
                                <button class="btn btn-light m-1"><i class="ri-eye-line me-1 align-middle d-inline-block"></i>Preview</button>
