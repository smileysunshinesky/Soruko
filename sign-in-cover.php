                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="signin-password" class="form-label text-default d-block">Password<a href="reset-password-basic.php" class="float-end text-danger">Forget password ?</a></label>
