                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body p-5">
                                <div class="text-center text-primary h5 fw-medium mb-5">UDON - Terms & Conditions
                                </div>
                                <div class="terms-conditions" id="terms-scroll">
                                    <div class="mb-4">
                                        <p class="mb-3">
                                            <span class="fw-medium text-default">If you stay in the USA </span>the UDON <a class="text-primary" href="javascript:void(0);"><u>Terms and Conditions</u></a> consists of below rules and <a class="text-primary" href="javascript:void(0);"><u>User Agreements</u></a> consists of below policies <a class="text-primary" href="javascript:void(0);"><u>Udon Rules & Privacy Policies</u></a> incorporated with the below conditions.
                                        </p>
                                        <p class="mb-0">
                                            <span class="fw-medium text-default">If you stay any where in the world other than USA </span>the UDON <a class="text-primary" href="javascript:void(0);"><u>Terms and Conditions</u></a> consists of below rules and <a class="text-primary" href="javascript:void(0);"><u>User Agreements</u></a> consists of below policies <a class="text-primary" href="javascript:void(0);"><u>Udon Rules & Privacy Policies</u></a> incorporated with the below conditions.
                                        </p>
                                    </div>
                                    <h6 class="fw-medium pb-3 text-primary text-decoration-underline"><span>Terms & Services :</span></h6>
                                    <div class="mb-4">
                                        <p class="fw-medium mb-2 fs-14">Lorem ipsum dolor sit amet.</p>
                                    ...
                                    <div class="mb-4">
                                        <p class="fw-medium mb-2 fs-14">Consectetur adipisicing elit.</p>
                                    ...
                                    <div class="mb-4">
                                        <p class="fw-medium mb-2 fs-14">There are many variations.</p>
                                        <p class="text-muted">
                                    ...
                                    <div class="mb-4">
                                        <p class="fw-medium mb-2 fs-14">If you allow your users to share.</p>
                                        <p class="mb-2 text-muted">
                                    ...
                                    <div class="mb-0">
                                        <p class="fw-medium mb-2 fs-14">You could also make it clear.</p>
                                        <p class="mb-2 text-muted">
                            ...
                            <div class="card-footer">
                                <div class="btn-list text-center">
                                    <button class="btn btn-outline-danger btn-wave btn-w-lg">DECLINE</button>
                                    <button class="btn btn-primary btn-wave btn-w-lg">ACCEPT</button>
                                </div>
                            </div>
                        </div>
                    </div>
