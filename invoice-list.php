                    ...
                    <div class="col-xl-9">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="d-flex">
                                    <button class="btn btn-sm btn-primary btn-wave waves-light"><i class="ri-add-line fw-medium align-middle me-1"></i> Create Invoice</button>
                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-6 pe-xl-0">
                                        <div class="p-3 border border-dashed border-2 rounded text-center">
                                            <div class="svg-icon-background bg-primary-transparent mb-3 svg-primary mx-auto"> 
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <div class="pb-0 mt-0"> 
                                                    <div> 
                                                        <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-center flex-wrap">$<span class="count-up" data-count="192">192</span>.87K<span class="badge bg-primary fw-normal ms-2 fs-10">
                                                            12,345
                                                        </span> </h4> 
                                    ...
                                    <div class="col-xl-6">
                                        <div class="p-3 border border-dashed border-2 rounded text-center">
                                            <div class="svg-icon-background bg-success-transparent mb-3 svg-success mx-auto"> 
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <div> 
                                                    <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-center flex-wrap">$<span class="count-up" data-count="68.83">68.83</span>K<span class="badge bg-success ms-2 fs-10">
                                                        4,176
                                                    </span> </h4> 
                                                    <p class="text-muted fs-11 mb-0 lh-1">
                                    ...
                                    <div class="col-xl-6 pe-xl-0">
                                        <div class="p-3 border border-dashed border-2 rounded text-center">
                                            <div class="svg-icon-background bg-warning-transparent mb-3 svg-warning mx-auto"> 
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <div> 
                                                    <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-center flex-wrap">$<span class="count-up" data-count="81.57">81.57</span>K<span class="badge bg-warning ms-2 fs-10">
                                                        7,064
                                                    </span> </h4> 
                                                    <p class="text-muted fs-11 mb-0 lh-1">
                                                        <span class="text-success me-1 fw-medium">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="p-3 border border-dashed border-2 rounded text-center">
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <div> 
                                                    <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-center flex-wrap">$<span class="count-up" data-count="32.47">32.47</span>K<span class="badge bg-light text-default ms-2 fs-10">
                                                        1,105
                                                    </span> </h4> 
                                                    <p class="text-muted fs-11 mb-0 lh-1">
                                ...
                                <div class="mt-4">
                                    <p class="fs-15 mb-4 fw-medium">Invoice Status <span class="text-muted fw-normal">(Last 6 months) :</span></p>
