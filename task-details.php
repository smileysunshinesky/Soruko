                    ...
                    <div class="col-xl-9">
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="btn-list">
                                    <button type="button" class="btn btn-success btn-sm btn-wave me-0"><i class="ri-edit-line me-1 align-middle"></i>Edit Task</button>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled profile-timeline">
                                    <li>
                                        <div>
                                            ...
                                            <p class="mb-2">
                                                <span class="fw-medium">You</span> Commented on <span class="fw-medium">Work Process</span> in this task <a class="text-secondary" href="javascript:void(0);"><u>#New Task</u></a>.<span class="float-end fs-11 text-muted">24,Dec 2023 - 14:34</span>
                                            </p>
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <p class="mb-1">
                                                <span class="fw-medium">Json</span> Commented on Task post <a class="text-secondary" href="javascript:void(0);"><u>#UI Technologies</u></a>.<span class="float-end fs-11 text-muted">24,Dec 2023 - 14:34</span>
                                            </p>
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="card custom-card overflow-hidden">
                            <div class="card-header justify-content-between">
                                ...
                                <div>
                                    <button type="button" class="btn btn-secondary-light btn-sm btn-wave"><i class="ri-add-line me-1 align-middle"></i>Sub Task</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <ul class="list-group">
