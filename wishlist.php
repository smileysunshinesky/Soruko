                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Dapzem & Co<span class="float-end text-warning fs-12">4.2<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Branded hoodie ethnic style</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$229<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$1,799</span></span><span class="badge bg-secondary-transparent float-end fs-10">72% off</span></p>
                            ...
                            <div class="card-footer text-center">
                                <a href="cart.php" class="btn btn-primary-ghost m-1"><i class="ri-shopping-cart-2-line me-2 align-middle d-inline-block"></i>Move To Cart</a>
                                <a href="product-details.php" class="btn btn-success-ghost m-1"><i class="ri-eye-line me-2 align-middle d-inline-block"></i>View Product</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Aus Polo Assn<span class="float-end text-warning fs-12">4.5<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Snow jacket with low pockets</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$1,899<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$3,799</span></span><span class="badge bg-secondary-transparent float-end fs-10">50% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Jimmy Lolfiger<span class="float-end text-warning fs-12">4.5<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Unisex jacket for men & women</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$1,199<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$3,299</span></span><span class="badge bg-secondary-transparent float-end fs-10">62% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">BMW<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Ethnic wear jackets form BMW</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$1,499<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$2,499</span></span><span class="badge bg-secondary-transparent float-end fs-10">38% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Denim Corporation<span class="float-end text-warning fs-12">4.4<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Flap pockets denim jackets for men</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$299<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$399</span></span><span class="badge bg-secondary-transparent float-end fs-10">35% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Denim Winjo<span class="float-end text-warning fs-12">4.0<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Vintage pure leather Jacket</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$599<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$2,499</span></span><span class="badge bg-secondary-transparent float-end fs-10">75% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Pufa<span class="float-end text-warning fs-12">3.8<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Ergonic designed full sleeve coat</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$2,399<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$5,699</span></span><span class="badge bg-primary-transparent float-end fs-10">72% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Louie Phillippe<span class="float-end text-warning fs-12">4.0<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Ergonic green colored full sleeve jacket</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$1,899<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$3,299</span></span><span class="badge bg-primary-transparent float-end fs-10">60% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                    <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,899</p>
                            </div>
                            <div class="card-footer text-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Bluberry Co.In<span class="float-end text-warning fs-12">4.2<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Full sleeve white hoodie</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$349<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$1,299</span></span><span class="badge bg-secondary-transparent float-end fs-10">60% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Blueberry & Co<span class="float-end text-warning fs-12">4.0<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Light colored sweater form blueberry</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$499<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$799</span></span><span class="badge bg-primary-transparent float-end fs-10">32% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Denim Corp<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">beautiful brown colored snow jacket</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$2,499<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$4,999</span></span><span class="badge bg-primary-transparent float-end fs-10">50% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                    ...
                    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="card custom-card product-card">
                            <div class="card-body">
                                ...
                                <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">Garage & Co<span class="float-end text-warning fs-12">4.3<i class="ri-star-s-fill align-middle ms-1"></i></span></p>
                                <p class="product-description fs-11 text-muted mb-2">Full sleeve sweat shirt</p>
                                <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$249<span class="text-muted text-decoration-line-through ms-1 op-6 d-inline-block">$1,299</span></span><span class="badge bg-primary-transparent float-end fs-10">70% off</span></p>
                                <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
