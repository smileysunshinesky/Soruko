                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-4">
                                            ...
                                            <div class="flex-fill main-profile-info">
                                                <div class="d-flex align-items-center justify-content-between mb-1">
                                                    <h6 class="fw-medium mb-1">Toni Stark</h6>
                                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                MIG-1-11, Monroe Street, Georgetown, USA,20071
                                            </p>
                                        </div>
                                    </div>
                                    <div class="skills-section">
                                        ...
                                        <div class="d-flex align-items-center gap-2 flex-wrap mb-4">
                                            <a href="javascript:void(0);">
                                                <span class="badge bg-light border text-muted fw-medium">Cloud computing</span>
                                            </a>
                                            <a href="javascript:void(0);">
                                                <span class="badge bg-light border text-muted fw-medium">Data analysis</span>
                                            </a>    
                                            <a href="javascript:void(0);">
                                                <span class="badge bg-light border text-muted fw-medium">DevOps</span>
                                            </a>
                                            <a href="javascript:void(0);">
                                                <span class="badge bg-light border text-muted fw-medium">Machine learning</span>
                                            </a>
                                            <a href="javascript:void(0);">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <span class="fs-12 text-muted">Toni Stark</span>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="d-flex flex-wrap align-items-center">
                                            ...
                                            <span class="fs-12 text-muted">tonistark231@gmail.com</span>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="d-flex flex-wrap align-items-center">
