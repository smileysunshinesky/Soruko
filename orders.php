                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-body d-flex align-items-center flex-wrap">
                                <div class="flex-fill">
                                    <span class="mb-0 fs-14 text-muted">Total number of orders placed upto now : <span class="fw-medium text-success">28</span></span>
                                </div>
                                <div class="dropdown">
                        ...
                        <div class="card custom-card">
                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Odemi A2 (Sea Green, 2GB RAM, 64GB Storage)</span>
                                        </a>
                                        <span class="d-block text-success">$1,299</span>
                                    </div>
                                    <div class="text-sm-center">
                                        <span class="fs-14 fw-medium">Order Id :</span>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto text-end">
                                        <span class="text-muted fs-12">Delivered By</span>
                                        <span class="d-block text-primary fw-medium">13-12-2023</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-sm-flex d-block align-items-center justify-content-between">
                                ...
                                <div class="mt-sm-0 mt-2">
                                    <button class="btn btn-sm btn-danger-ghost">Cancel Order</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Bluetooth Wireless Headphone (aura)</span>
                                        </a>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto text-end">
                                        <span class="text-muted fs-12">Delivered By</span>
                                        <span class="d-block text-primary fw-medium">25-11-2023</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-sm-flex d-block align-items-center justify-content-between">
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Theme Wall Clock (20.5 cm x 20.5 cm x 3.5 cm)</span>
                                        </a>
                            ...
                            <div class="card-footer d-sm-flex d-block justify-content-between align-items-center">
                                <div class="fs-11">
                                    ...
                                    <span class="fw-medium">29,Oct 2023 - 12:47PM</span>
                                </div>
                                <div class="mt-sm-0 mt-2">
                                    <button class="btn btn-sm btn-primary-ghost">Rate Product<i class="bi bi-star-fill ms-2 fs-12 text-warning"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">xenon Instax Mini 12 Instant Camera-Orange</span>
                                        </a>
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Smart Watch with Bluetooth Calling, AI</span>
                                        </a>
                            ...
                            <div class="card-footer d-sm-flex d-block justify-content-between align-items-center">
                                <div class="fs-11">
                                    <span>Delivered on:</span>
                                    <span class="fw-medium">4,Nov 2023 - 10:24AM</span>
                                </div>
                                <div class="mt-sm-0 mt-2">
                                    <button class="btn btn-sm btn-primary-ghost">Rate Product<i class="bi bi-star-fill ms-2 fs-12 text-warning"></i></button>
                                </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Pufa Red Casual Sneaker High-Neck Shoes</span>
                                        </a>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto text-end">
                                        <span class="text-muted fs-12">Delivered By</span>
                                        <span class="d-block text-primary fw-medium">16-01-2024</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-sm-flex d-block align-items-center justify-content-between">
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Single Seater Premium Wing Back Cushioned</span>
                                        </a>
                                        <span class="d-block text-success">$499</span>
                                    </div>
                                    <div class="text-sm-center">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto text-end">
                                        <span class="text-muted fs-12">Delivered By</span>
                                        <span class="d-block text-primary fw-medium">19-12-2023</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-sm-flex d-block align-items-center justify-content-between">
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Fiber Reinforced Plastic Pot, Blue, 1 Piece</span>
                                        </a>
                                        <span class="d-block text-success">$499</span>
                                    </div>
                                    <div class="text-sm-center">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto text-end">
                                        <span class="text-muted fs-12">Delivered By</span>
                                        <span class="d-block text-primary fw-medium">24-12-2023</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-sm-flex d-block align-items-center justify-content-between">
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Fashion High-Top Lace-Up Slim Heels Sandals</span>
                                        </a>
                                        <span class="d-block text-success">$499</span>
                                    </div>
                                    <div class="text-sm-center">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto text-end">
                                        <span class="text-muted fs-12">Delivered By</span>
                                        <span class="d-block text-primary fw-medium">16-11-2023</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-sm-flex d-block align-items-center justify-content-between">
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Men's Cotton Blend Hooded Cardigan</span>
                                        </a>
                                        <span class="d-block text-success">$1,899</span>
                                    </div>
                                    <div class="text-sm-center">
                            ...
                            <div class="card-footer d-sm-flex d-block justify-content-between align-items-center">
                                <div class="fs-11">
                                    <span>Delivered on:</span>
                                    <span class="fw-medium">04,Nov 2023 - 03:12PM</span>
                                </div>
                                <div class="mt-sm-0 mt-2">
                                    <button class="btn btn-sm btn-primary-ghost">Rate Product<i class="bi bi-star-fill ms-2 fs-12 text-warning"></i></button>
                                </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex d-block align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">SPK 12 L Mini Backpack (Small Size, Yellow)</span>
                                        </a>
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-block">
                                <div class="d-sm-flex align-items-center ">
                                    ...
                                    <div class="flex-fill">
                                        <a href="javascript:void(0)">
                                            <span class="fs-14 fw-medium">Narichavo Branded Headphones</span>
                                        </a>
                                        <span class="d-block text-success">$249</span>
                                    </div>
                                    <div class="text-sm-center">
                            ...
                            <div class="card-footer d-sm-flex d-block justify-content-between align-items-center">
                                <div class="fs-11">
                                    <span>Delivered on:</span>
                                    <span class="fw-medium">22,Oct 2023 - 05:15PM</span>
                                </div>
                                <div class="mt-sm-0 mt-2">
                                    <button class="btn btn-sm btn-primary-ghost">Rate Product<i class="bi bi-star-fill ms-2 fs-12 text-warning"></i></button>
                                </div>
