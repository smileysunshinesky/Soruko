                            ...
                            <div class="card-header d-md-flex d-block">
                                <div class="h5 mb-0 d-sm-flex d-bllock align-items-center">
                                    ...
                                    <div class="ms-sm-2 ms-0 mt-sm-0 mt-2">
                                        <div class="h6 fw-medium mb-0">SHOPPING INVOICE : <span class="text-primary">#8140-2099</span></div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-xl-3">
                                        ...
                                        <p class="fs-15 mb-1">29,Nov 2023 - <span class="text-muted fs-12">12:42PM</span></p>
                                      </div>
                                    <div class="col-xl-3">
                                        <p class="fw-medium text-muted mb-1">Due Date :</p>
                                        <p class="fs-15 mb-1">29,Dec 2023</p>
                                    </div>
                                    <div class="col-xl-3">
                                        <p class="fw-medium text-muted mb-1">Due Amount :</p>
                                        <p class="fs-16 mb-1 fw-medium">$2,570.42</p>
                                    </div>
                                    <div class="col-xl-12">
                            ...
                            <div class="card-body">
                                <div class="row gy-3">
                                    <div class="col-xl-12">
                                        ...
                                        <p>
                                            <span class="fw-medium text-muted fs-12">Name On Card :</span> Toni Stark
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            <span class="fw-medium text-muted fs-12">Due Date :</span> 29,Dec 2023 - <span class="text-danger fs-12 fw-medium">30 days due</span>
                                        </p>
                                        <p>
