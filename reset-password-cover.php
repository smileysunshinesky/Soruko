                    ...
                    <div class="card custom-card shadow-none my-4">
                        <div class="card-body p-4">
                            <div class="mb-3 d-flex justify-content-center">
                                <a href="index.php">
                                    <img src="assets/images/brand-logos/desktop-logo.png" alt="logo" class="authentication-brand desktop-logo">
                                    <img src="assets/images/brand-logos/desktop-dark.png" alt="logo" class="authentication-brand desktop-dark">
                                </a>
                            </div>
                            <p class="h5 mb-2 text-center">Reset Password</p>
                            <p class="mb-4 text-muted op-7 fw-normal text-center">Hello Stark !</p>
                            <div class="row gy-3">
                                <div class="col-xl-12">
                            ...
                            <div class="d-grid mt-4">
                                <a href="sign-in-basic.php" class="btn btn-lg btn-primary">Create</a>
                            </div>
                            <div class="text-center">
                                <p class="text-muted mt-3">Already have an account? <a href="sign-in-basic.php" class="text-primary">Sign In</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="authentication-cover bg-primary">
                <div>
                    ...
                    <div class="text-center mb-4">
                        <h1 class="text-fixed-white">Reset Password</h1>
                    </div>
