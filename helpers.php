            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h1 class="page-title fw-medium fs-18 mb-2">Helpers</h1>
                            <div class="">
                                <nav>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-evenly flex-wrap">
                                        <a href="javascript:void(0);" class="link-primary fw-medium fs-15 p-1">Primary</a>
                                        <a href="javascript:void(0);" class="link-secondary fw-medium fs-15 p-1">Secondary</a>
                                        <a href="javascript:void(0);" class="link-success fw-medium fs-15 p-1">Success</a>
                                        <a href="javascript:void(0);" class="link-danger fw-medium fs-15 p-1">Danger</a>
                                        <a href="javascript:void(0);" class="link-warning fw-medium fs-15 p-1">Warning</a>
                                        <a href="javascript:void(0);" class="link-info fw-medium fs-15 p-1">Info</a>
                                        <a href="javascript:void(0);" class="link-light fw-medium fs-15 p-1">Light</a>
                                        <a href="javascript:void(0);" class="link-dark fw-medium fs-15 p-1">Dark</a>
                                    </div>
                                </div>
                            </div>
                        </div>
