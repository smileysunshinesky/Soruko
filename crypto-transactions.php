                    ...
                    <div class="col-xl-3">
                        <div class="card custom-card">
                            <div class="card-body">
                                    ...
                                    <div class="col-xxl-6 pe-xxl-0">
                                        <div class="p-3 border border-dashed border-2 rounded text-center">
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <div class="pb-0 mt-0"> 
                                                    <div> 
                                                        <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-center"><span class="count-up" data-count="42">42</span><span class="badge bg-primary fw-normal ms-2 fs-10">
                                                            12,345
                                                        </span> </h4> 
                                    ...
                                    <div class="col-xxl-6">
                                        <div class="p-3 border border-dashed border-2 rounded text-center">
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <div> 
                                                    <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-center"><span class="count-up" data-count="320">320</span><span class="badge bg-success ms-2 fs-10">
                                                        4,176
                                                    </span> </h4> 
                                                    <p class="text-muted fs-11 mb-0 lh-1">
                                    ...
                                    <div class="col-xxl-6 pe-xxl-0">
                                        <div class="p-3 border border-dashed border-2 rounded text-center">
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <div> 
                                                    <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-center"><span class="count-up" data-count="81">81</span><span class="badge bg-warning ms-2 fs-10">
                                                        7,064
                                                    </span> </h4> 
                                                    <p class="text-muted fs-11 mb-0 lh-1">
                                                        <span class="text-success me-1 fw-medium">
                                    ...
                                    <div class="col-xxl-6">
                                        <div class="p-3 border border-dashed border-2 rounded text-center">
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <div> 
                                                    <h4 class="fs-18 fw-medium mb-2 d-flex align-items-center justify-content-center"><span class="count-up" data-count="33">33</span>K<span class="badge bg-light text-default ms-2 fs-10">
                                                        1,105
                                                    </span> </h4> 
                                                    <p class="text-muted fs-11 mb-0 lh-1">
                                ...
                                <div class="mt-4">
                                    <p class="fs-15 fw-medium">Transactions Statistics<span class="text-muted fw-normal">(Last 6 months) :</span></p>
