        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h1 class="page-title fw-medium fs-18 mb-2">Create Blog</h1>
                        <div class="">
                            <nav>
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex gap-2 flex-wrap align-items-center">
                                            ...
                                            <div class="flex-fill">
                                                <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Health</a>
                                                <p class="mb-1 popular-blog-content text-truncate">
                                                    It was popularised in the 1960s with the release of Letraset sheets containing
                                                </p>
                                                <span class="text-muted fs-11">16,Dec 2023 - 04:56</span>
                                            </div>
                                            <div>
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm rtl-rotate"><i class="ri-arrow-right-s-line"></i></button>
                                            </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex gap-2 flex-wrap align-items-center">
                                            ...
                                            <div class="flex-fill">
                                                <a href="javascript:void(0);" class="fs-14 fw-medium mb-0">Food</a>
                                                <p class="mb-1 popular-blog-content text-truncate">
                                                    It was popularised in the 1960s with the release of Letraset sheets containing
                                                </p>
                                                <span class="text-muted fs-11">31,Dec 2023 - 18:06</span>
                                            </div>
                                            <div>
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm rtl-rotate"><i class="ri-arrow-right-s-line"></i></button>
                                            </div>
                                    ...
                                    <li class="list-group-item">
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <span class="text-muted fs-11">15,Dec 2023 - 14:31</span>
                                            </div>
                                            <div>
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm rtl-rotate"><i class="ri-arrow-right-s-line"></i></button>
                                            </div>
