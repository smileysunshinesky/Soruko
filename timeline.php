                            ...
                            <div class="col-lg-12">
                                <div class="timeline-container">
                                    <div class="timeline-end">
                                        <span class="avatar avatar-lg bg-primary-transparent backdrop-blur text-center">
                                            <span class="fs-13">2023</span>
                                        </span>
                                    </div>
                                    <div class="timeline-continue">
                                        <div class="row timeline-right">
                                            ...
                                            <div class="col-md-6">
                                                <div class="timeline-box d-flex gap-3 align-items-start">
                                                    <div class="lh-1">
                                                        <span class="avatar avatar-rounded">
                                                            <img src="assets/images/faces/11.jpg" alt="">
                                                        </span>
                                                    ...
                                                    <div class="timeline-text">
                                                        <h6 class="fw-medium mb-1">Christopher</h6>
                                                        <p class="mb-0 text-muted">Project assigned by the manager all<span class="badge bg-primary-transparent fw-medium mx-1">files</span>and<span class="badge bg-primary-transparent fw-medium mx-1">folders</span>were included</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row timeline-left">
                                            <div class="col-md-6">
                                                <div class="timeline-box d-flex gap-3 align-items-start ms-md-auto">
                                                    <div class="timeline-text flex-fill">
                                                        <h6 class="fw-medium mb-1">Isabella</h6>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="timeline-year">
                                                    <span class="avatar avatar-lg bg-success-transparent backdrop-blur text-center">
                                                        <span class="fs-13">2024</span>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row timeline-right">
                                            ...
                                            <div class="col-md-6">
                                                <div class="timeline-box d-flex gap-3 align-items-start">
                                                    ...
                                                    <div class="timeline-text">
                                                        <h6 class="fw-medium mb-1">Scarlett</h6>
                                                        <p class="mb-0 text-muted">Temporary data will be <span class="badge bg-danger-transparent fw-medium mx-1">deleted</span> once dedicated time complated</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row timeline-left">
                                            <div class="col-md-6">
                                                <div class="timeline-box d-flex gap-3 align-items-start ms-md-auto">
                                                    <div class="timeline-text flex-fill">
                                                        <h6 class="fw-medium mb-1">Richard</h6>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="timeline-year">
                                                    <span class="avatar avatar-lg bg-danger-transparent backdrop-blur text-center">
                                                        <span class="fs-13"> 2024</span>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row timeline-right">
                                            ...
                                            <div class="col-md-6">
                                                <div class="timeline-box d-flex gap-3 align-items-start">
                                                    ...
                                                    <div class="timeline-text">
                                                        <h6 class="fw-medium mb-1">Benjamin</h6>
                                                        <p class="mb-0 text-muted">Social network accounts are at risk check your <span class="badge bg-success-transparent fw-medium mx-1">login</span> details</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row timeline-left">
                                            <div class="col-md-6">
                                                <div class="timeline-box d-flex gap-3 align-items-start ms-md-auto">
                                                    <div class="timeline-text flex-fill">
                                                        <h6 class="fw-medium mb-1">Olivia</h6>
                                    ...
                                    <div class="timeline-start">
                                        <span class="avatar avatar-lg bg-warning-transparent backdrop-blur text-center">
                                            <span class="fs-13">2024</span>
                                        </span>
                                    </div>
                                </div>
