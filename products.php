                            ...
                            <div class="row">
                                    ...
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/7.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                                <a href="product-details.php" class="view"><i class="ri-eye-line"></i></a>
                                            </div>
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">HavenHub<span class="float-end text-warning fs-12">4.2<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">HavenHub is your hub for home essentials</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$229<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$1,799</span></span><span class="badge bg-green float-end fs-10">72% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/10.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">BlissBoutique<span class="float-end text-warning fs-12">4.0<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">Step into a world of bliss at BlissBoutique</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$599<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-green float-end fs-10">75% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/8.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">TechNexxus<span class="float-end text-warning fs-12">4.5<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">TechNexxus is the future of technology</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$1,199<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$3,299</span></span><span class="badge bg-green float-end fs-10">62% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/12.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">NatureNest<span class="float-end text-warning fs-12">4.2<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">Nestle into nature with NatureNest</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$349<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$1,299</span></span><span class="badge bg-green float-end fs-10">60% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/9.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">AllureWares<span class="float-end text-warning fs-12">4.5<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">Rediscover your natural allure</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$1,899<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$3,799</span></span><span class="badge bg-green float-end fs-10">50% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/13.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">ElectraMart<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2"> Find the latest gadgets, appliances</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$1,499<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$2,499</span></span><span class="badge bg-green float-end fs-10">38% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/14.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">AquaGrove<span class="float-end text-warning fs-12">4.4<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">Dive and explore a world of aquatic wonders</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$299<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$399</span></span><span class="badge bg-green float-end fs-10">35% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/15.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">TrendyTreasures<span class="float-end text-warning fs-12">3.8<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">Unearth hidden treasures at TrendyTreasures</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$2,399<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$5,699</span></span><span class="badge bg-primary-transparent float-end fs-10">72% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/16.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">GigaGoods<span class="float-end text-warning fs-12">4.0<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">Discover a world of GigaGoods</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$1,899<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$3,299</span></span><span class="badge bg-primary-transparent float-end fs-10">60% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                                <i class="ti ti-discount-2 fs-16 me-1"></i>Offer Price $1,899</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/17.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">SwiftStyle<span class="float-end text-warning fs-12">4.1<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">SwiftStyle offers fashion that keeps</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$2,499<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$4,999</span></span><span class="badge bg-primary-transparent float-end fs-10">50% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/18.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">UrbanHaven<span class="float-end text-warning fs-12">4.3<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">Turn your home into an UrbanHaven</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$249<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$1,299</span></span><span class="badge bg-primary-transparent float-end fs-10">70% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                ...
                                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card product-card">
                                        <div class="card-body">
                                            <a href="product-details.php" class="product-image">
                                                <img src="assets/images/ecommerce/jpg/11.jpg" class="card-img mb-3" alt="...">
                                            </a>
                                            <div class="product-icons">
                                                <a href="wishlist.php" class="wishlist"><i class="ri-heart-line"></i></a>
                                                <a href="cart.php" class="cart"><i class="ri-shopping-cart-line"></i></a>
                                            ...
                                            <p class="product-name fw-medium mb-0 d-flex align-items-center justify-content-between">EcoTrend<span class="float-end text-warning fs-12">4.0<i class="ri-star-s-fill align-middle ms-1 d-inline-block"></i></span></p>
                                            <p class="product-description fs-11 text-muted mb-2">Join the eco-friendly with EcoTrend</p>
                                            <p class="mb-1 fw-medium fs-16 d-flex align-items-center justify-content-between"><span>$499<span class="text-muted text-decoration-line-through ms-1 d-inline-block op-6">$799</span></span><span class="badge bg-primary-transparent float-end fs-10">32% off</span></p>
                                            <p class="fs-11 text-success fw-medium mb-0 d-flex align-items-center">
                                    ...
                                    <div class="p-4 border-bottom">
                                        ...
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">512</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">2,186</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">734</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">16</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">1,432</span>
                                            </div>
                                            <div class="collapse" id="brands-more">
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">257</span>
                                                </div>
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">1,845</span>
                                                </div>
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">5,893</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="p-4 border-bottom">
                                        ...
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">22,873</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">11,345</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">6,987</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">5,236</span>
                                            </div>
                                            <div class="form-check mb-4">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">3,735</span>
                                            </div>
                                    ...
                                    <div class="p-4 border-bottom">
                                        ...
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">2,712</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">536</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">18,289</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">3,453</span>
                                            </div>
                                            <div class="collapse" id="category-more">
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">7,165</span>
                                                </div>
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">5,964</span>
                                                </div>
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">2,123</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="p-4 border-bottom">
                                        ...
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">16,563</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">15,234</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">6,278</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">4,531</span>
                                            </div>
                                            <div class="form-check">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">2,405</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="p-4">
                                        ...
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">23,156</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">15,632</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">15,032</span>
                                            </div>
                                            <div class="form-check mb-2">
                                                ...
                                                <span class="badge bg-primary-transparent float-end">7,154</span>
                                            </div>
                                            <div class="collapse" id="sizes-more">
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">5,946</span>
                                                </div>
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">3,267</span>
                                                </div>
                                                <div class="form-check mb-2">
                                                    ...
                                                    <span class="badge bg-primary-transparent float-end">578</span>
                                                </div>
                                            </div>
